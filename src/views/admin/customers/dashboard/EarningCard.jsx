                    ...
                    <Box sx={{ p: 2.25 }}>
                        <Grid container direction="column">
                            <Grid item>
                                <Grid container justifyContent="space-between">
                                    <Grid item>
                                        ...
                                        >
                                            {/* Changed icon to IconCurrencyDollar for a more professional look */}
                                            <IconCurrencyDollar fontSize="inherit" />
                                        </Avatar>
                                    </Grid>
                                    <Grid item>
                                        <Avatar
                            ...
                            <Grid item>
                                ...
                                >
                                    Instantly transfer money to any number
                                </Typography>
                                {/* Button */}
                                <Button
                                    variant="contained"
                                    color="secondary"
                                    fullWidth
                                    sx={{ fontWeight: 700, borderRadius: 2, boxShadow: 3 }}
                                >
                                    Send Money
                                </Button>
                            </Grid>
