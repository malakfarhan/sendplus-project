...
// dashboard routing
const DashboardDefault = Loadable(lazy(() => import('views/admin/customers/dashboard')));
const DashboardAnalytics = Loadable(lazy(() => import('views/dashboard/Analytics')));
const MobileNetworks = Loadable(lazy(() => import('views/dashboard/mobile-networks/index')));
const DashboardMobilePackages = Loadable(lazy(() => import('views/dashboard/MobilePackages/index')));
const DataPackagesPage = Loadable(lazy(() => import('views/admin/customers/dashboard/DataPackagesPage')));
const DataPackegesForm = Loadable(lazy(() => import('views/dashboard/data-packges/index')));
// const DataPackegesTable = Loadable(lazy(() => import('views/dashboard/data-packges/DataPackegesTable')));
const CategoryTable = Loadable(lazy(() => import('views/dashboard/mobile-networks/index')));
...
const MainRoutes = {
    ...
    children: [
        ...
        ////////////SENDPLUS.  APLLICATION DASHBOARD ROUTES //////////////////
        {
            path: '/dashboard/data-packages',
            element: <DataPackegesForm />
        },
        {
            path: '/dashboard/mobile-packages',
            element: <DashboardMobilePackages />
        },
         {
            path: '/dashboard/mobile-networks',
            element: <DataPackagesPage />
        },
        {
        ...
        //  {
        //     path: '/dashboard/data-packages-table',
        //     element: <DataPackegesTable />
        // },
          {
            path: '/dashoard/mobile-networks',
            element: <MobileNetworks />
        },
